...
#use LOESS_output_mousePOA.txt file for POA analysis
loess_data <- read.delim("LOESS_output_mousePH.txt", header=TRUE, check.names=FALSE)
...
write.table(x=loess_corr_flat_gene, file="Tacr3_coexp_mousePH.txt",quote=FALSE, sep="\t", row.names=TRUE, col.names=TRUE)
