...
##for example: supplemental data table S8 (for human data) or supplemental data table S2 (for mouse data)
express_log2FCrank_file <- read.delim("supplementalTableS8.txt", header=TRUE, check.names=FALSE)
...
##supplemental data table S7 (for human data) or supplemental data table S1 (for mouse data)

heatmap_dataframe <- read.delim("supplementalTableS7.txt", header=TRUE, check.names=FALSE)
