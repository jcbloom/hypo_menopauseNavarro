...
Each folder contains code and processed data that may be used to recreate one or more figures and tables:  
  ...
  LOESS analysis: Fig. 4, Fig. S7, Table S6
  
  Gene Set Enrichment Analysis: Fig. 1, Fig. 6, Table S1, Table S7
  
  Differential Gene Expression Analysis: Fig. 2, Fig. 5, Fig. S3, Table S2, Table S3, Table S8, Table S9
  
  Co-expression Analysis: Fig. 6, Table S11
